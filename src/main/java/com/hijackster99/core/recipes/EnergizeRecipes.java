...
public class EnergizeRecipes implements IRecipe<IInventory> {

	public static final IRecipeType<EnergizeRecipes> ENERGIZE_RECIPES = IRecipeType.register("energize_recipes");
	...
	public EnergizeRecipes(ResourceLocation loc, String group, Ingredient ingr, int voidEnergy, ItemStack result) {
		this.loc = loc;
		this.group = group;
		this.ingr = ingr;
