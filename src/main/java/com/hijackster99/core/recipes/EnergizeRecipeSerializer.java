...
public class EnergizeRecipeSerializer<T extends EnergizeRecipes> extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<T> {

	@ObjectHolder(References.MODID + ":energize_serializer")
	public static IRecipeSerializer<EnergizeRecipes> energizeSer;
	
	private final EnergizeRecipeSerializer.IFactory<T> factory;
	public EnergizeRecipeSerializer(EnergizeRecipeSerializer.IFactory<T> factory) {
		this.factory = factory;
        this.setRegistryName(References.MODID, "energize_recipes");
	}
	...
	public interface IFactory<T extends EnergizeRecipes> {
